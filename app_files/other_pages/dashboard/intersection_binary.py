...
PLOTS_CSS_PATH = CURRENT_DIR / 'plots_style.css'

def render_binary_dashboard_intersection(plots, descriptions, prefix=""):

    """
    Renders the binary dashboard with all plots and descriptions.
    prefix: a string to prefix all Streamlit container keys and CSS classes for uniqueness
    """

    with open(PLOTS_CSS_PATH) as f:
        css = f.read()
    ...
    def prefixed_key(key_name):
        return f"intersection_{prefix}_{key_name}" if prefix else key_name
    ...
    with st.container():
        ...
        with rashomon_set_col:
            ...
            with st.container(key = prefixed_key("basics")):
                st.markdown(
                        f"""
        ...
        with pareto_col:
            ...
            with st.container(key = prefixed_key("pareto"), height="stretch"):
                st.plotly_chart(pareto_plot, width='stretch', key = prefixed_key("pareto_plot"))
...
# RATIOS VS EPSILONS
    ...
    with st.container():
        ...
        use_probability = st.checkbox("Show probabilistic version", value=False, key=prefixed_key("use_probability_checkbox"))
        ...
        with st.container():
            with lolipop_col:
                ...
                with st.container(key = prefixed_key("lolipop_container")):
                    st.plotly_chart(amb_discr_plot, key=prefixed_key("amb_discr_plot"), width='stretch')
                    st.markdown(
            ...
            with amb_col:
                ...
                with st.container(key=prefixed_key("ambig_epsilon_container"), height="stretch"):
                    st.plotly_chart(amb_vs_eps_plot, width='stretch', key=prefixed_key("amb_vs_epsilon_plot"))
                    st.markdown(
            ...
            with discr_col:
                ...
                with st.container(key = prefixed_key("discr_epsilon_container"), height="stretch"):
                    st.plotly_chart(discr_vs_eps_plot, width='stretch', key=prefixed_key("discr_vs_epsilon_plot"))
                    st.markdown(
    ...
    with st.container():
        ...
        with rashomon_capacity_col:
            with st.container():
                ...
                with st.container(key=prefixed_key('capacity-hist')):
                    st.plotly_chart(capacity_hist, width='stretch', key=prefixed_key('capacity_hist_plot'))
                    st.markdown(
                ...
                with st.container(key=prefixed_key('capacity-boxplot'), height="stretch"):
                    st.plotly_chart(capacity_boxplot, width='stretch', key=prefixed_key('capacity_boxplot_plot'))
                    st.markdown(
        ...
        with per_sample_col:
            ...
            with st.container(key=prefixed_key('per_sample'), height="stretch"):
                st.plotly_chart(proba_probabilities_plot, width='stretch', key=prefixed_key('proba_probabilities_plot'))
                st.markdown(
            ...
            #rashomon capacity for sample container for plot and description
                with st.container(key=prefixed_key("capacity_per_sample_padding")):
                    st.plotly_chart(capacity_per_sample, width='stretch', key=prefixed_key('capacity_per_sample_plot'))
                    st.markdown(
    ...
    with st.container():
        ...
        with st.container():
            with percent_agreement_col:
                ...
                metric_option = st.radio(
                    ...
                    key=prefixed_key("agreement_metric_radio")
                )
                ...
                if metric_option=="Percent Agreement":
                    ...
                    with st.container(key = prefixed_key("percent_agreement")):
                        st.plotly_chart(percent_agreement_bar_plot, width='stretch', key=prefixed_key('percent_agreement_plot'))
                    ...
                    descr = '''
                        ...
                        '''
                    st.markdown(f'<div class="section_description less_padding">{descr}</div>', unsafe_allow_html=True)
                    with st.container(key = prefixed_key("cohens_kappa_barplot")):
                        st.plotly_chart(cohens_kappa_barplot, width='stretch', key=prefixed_key('cohens_kappa_plot'))
        ...
        with st.container():
            with agreement_rates_col:
                ...
                with st.container(key=prefixed_key('agreement_rates_violin')):
                    st.plotly_chart(agreement_rates_violin_plot, width='stretch', key=prefixed_key('agreement_rates_violin_plot'))
                    st.markdown(
    ...
    with st.container():
        with st.container():
            ...
            with hist_col:
                ...
                with st.container(key=prefixed_key('vprs_hist'), height="stretch"):
                    st.plotly_chart(vprs_hist_plot, width='stretch', key=prefixed_key('vprs_hist_plot'))
                    st.markdown(
            ...
            with by_class_col:
                ...
                with st.container(key=prefixed_key('vprs_by_class'), height="stretch"):
                    st.plotly_chart(vprs_by_class_plot, width='stretch', key=prefixed_key('vprs_by_class_plot'))
                    st.markdown(
                        f'<div class="plots_descr">{plot_description}</div>',
                        unsafe_allow_html=True
                    )
            
            with st.container(key=prefixed_key('vprs_vs_base_model'), height="stretch"):
                chart_col, descr_col = st.columns([3, 1])
                with chart_col:
                    st.plotly_chart(vprs_vs_base_model_plot, width='stretch', key=prefixed_key('vprs_vs_base_model_plot'))
                with descr_col:
