...
def render_binary_dashboard(plots, descriptions, prefix=""):
    ...
    def prefixed_key(key_name):
        return f"{prefix}_{key_name}" if prefix else key_name
    ...
    with st.container():
        ...
        with basics_col:
            ...
            with st.container(key=prefixed_key("basics"), height="stretch"):
        ...
        with st.container():
            with lolipop_col:
                ...
                with st.container(key = prefixed_key("lolipop_container")):
                    st.plotly_chart(amb_discr_plot, key=prefixed_key("amb_discr_plot"))
                    st.markdown(
            ...
            with amb_col:
                ...
                with st.container(key=prefixed_key("ambig_epsilon_container"), height="stretch"):
                    st.plotly_chart(amb_vs_eps_plot, width='stretch', key=prefixed_key("amb_vs_eps_plot"))
                    st.markdown(
            ...
            with discr_col:
                ...
                with st.container(key=prefixed_key("discr_epsilon_container"), height="stretch"):
                    st.plotly_chart(discr_vs_eps_plot, width='stretch', key=prefixed_key("discr_vs_eps_plot"))
                    st.markdown(
            ...
            with percent_agreement_col:
                ...
                if metric_option=="Percent Agreement":
                    ...
                    with st.container(key=prefixed_key("percent_agreement")):
                        st.plotly_chart(percent_agreement_bar_plot, width='stretch', key=prefixed_key("percent_agreement_barplot"))
                    ...
                    with st.container(key = prefixed_key("cohens_kappa_barplot")):
                        st.plotly_chart(cohens_kappa_barplot, width='stretch', key=prefixed_key("cohens_kappa_barplot_plot"))
