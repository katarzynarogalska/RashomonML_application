...
def render_multiclass_dashboard(plots, descriptions, prefix=""):

    """
    Renders the multiclass dashboard with all plots and descriptions.
        ...
        with basics_col:
            ...
            with st.container(key=prefixed_key("basics"), height="stretch"):
                ...
                st.markdown(
                        f"""
                        <div style="font-size:15px; margin-bottom:10px;">
                             <span style="color: #426c85;font-family: 'Inter', sans-serif; padding-left:1.2vw;font-weight: 500; letter-spacing: 0.2px;">Base metric : </span>
                ...
                st.markdown(
                        f"""
                        <div style="font-size:15px; margin-bottom:10px;">
                            <span style="color: #426c85;font-family: 'Inter', sans-serif;padding-left:1.2vw; font-weight: 500; letter-spacing: 0.2px;">Base model's score : </span>
