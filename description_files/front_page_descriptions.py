...
rashomon_metrics="""
 ...
 • <strong>Rashomon Pattern Ratio</strong> - the fraction of number of unique prediction patterns generated by the models in the Rashomon Set, relative to the number of patterns generated by all available models.  <br>
 ...
 • <strong>Cohen's Kappa</strong> - for each model in the Rashomon Set, measures agreement between the model and the base model predictions adjusted for agreement expected to occur by chance.<br>
